...
directorio_trabajo = "articulos_x_procesar_ElHeraldo_Duplicados/"
origen = "elheraldo"
...
palabrasExcluir.add("el heraldo")
...
for archivo in os.listdir(directorio_trabajo):
    ...
    filename = archivo.replace("elheraldo_", "").replace(".csv", "")
...
# Guardar resultados
output_file = os.path.join(output_dir, "noticias_estandarizadas_Heraldo_24082025.json")
