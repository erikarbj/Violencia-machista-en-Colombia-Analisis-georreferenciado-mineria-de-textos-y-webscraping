...
directorio_trabajo = "articulos_x_procesar_ElUniversal_Duplicados                     /"
origen = "eluniversal"
...
for archivo in os.listdir(directorio_trabajo):
    ...
    filename = archivo.replace("eluniversal_", "").replace(".csv", "")
...
# Guardar resultados
output_file = os.path.join(output_dir, "noticias_estandarizadas_Universal_24082025.json")
