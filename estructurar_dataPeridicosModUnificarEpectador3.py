...
directorio_trabajo = "articulos_x_procesar_Espectador_Duplicados/"
origen = "elespectador"
...
def procesar_ubicacion(doc_text, pais, url=None):
    ...
    # 4. Entidades LOC con verificación estricta
    doc = nlp(doc_text)
    for ent in doc.ents:
        if ent.label_ == "LOC" and es_ubicacion_valida(ent.text):
...
# Guardar resultados
output_file = os.path.join(output_dir, "noticias_estandarizadas_Espectador_24082025.json")
